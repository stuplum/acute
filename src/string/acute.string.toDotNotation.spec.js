describe('acute.string', function() {
    ...
    describe('acute.string.toDotNotation', function() {
        ...
        var scenarios = [
            ...
            { it: 'should be part of the toDotNotation package', package: 'acute.string.toDotNotation' }
        ];
        ...
        scenarios.forEach(function (scenario) {
            ...
            it(scenario.it, function () {
                ...
                expect(function () { inject(function (stringToDotNotation) { /* injected service */ }) }).not.toThrow();
            });
        });

        describe('stringToDotNotation', function () {
