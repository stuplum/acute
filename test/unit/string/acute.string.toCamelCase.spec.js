describe('acute.string', function () {
    ...
    describe('acute.string.toCamelCase', function () {
        ...
        var scenarios = [
            ...
            { it: 'should be part of the toCamelCase package', package: 'acute.string.toCamelCase' }
        ];
        ...
        scenarios.forEach(function (scenario) {
            ...
            it(scenario.it, function () {
                ...
                expect(function () { inject(function (stringToCamelCase) { /* injected service */ }) }).not.toThrow();
            });
        });
